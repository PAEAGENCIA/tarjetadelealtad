...
const jsonLogo = express.json({ limit: '400kb' });
app.use((req, res, next) => (/\/logo$/.test(req.path) ? jsonLogo : jsonSmall)(req, res, next));
...
app.use('/api/businesses/:slug/growth', growthRouter);
